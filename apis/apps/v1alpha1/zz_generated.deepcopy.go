...
func (in *APIManagerSpec) DeepCopyInto(out *APIManagerSpec) {
	*out = *in
	...
	if in.PriorityClassesNames != nil {
		in, out := &in.PriorityClassesNames, &out.PriorityClassesNames
		*out = new(PriorityClassesNamesSpec)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PriorityClassesNamesSpec) DeepCopyInto(out *PriorityClassesNamesSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PriorityClassesNamesSpec.
func (in *PriorityClassesNamesSpec) DeepCopy() *PriorityClassesNamesSpec {
	if in == nil {
		return nil
	}
	out := new(PriorityClassesNamesSpec)
