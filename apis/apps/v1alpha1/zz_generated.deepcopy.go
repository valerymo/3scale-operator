...
func (in *APIManagerSpec) DeepCopyInto(out *APIManagerSpec) {
	*out = *in
	...
	if in.PriorityClassNameBackendPod != nil {
		in, out := &in.PriorityClassNameBackendPod, &out.PriorityClassNameBackendPod
		*out = new(string)
		**out = **in
	}
	if in.PriorityClassNameApicastPod != nil {
		in, out := &in.PriorityClassNameApicastPod, &out.PriorityClassNameApicastPod
		*out = new(string)
		**out = **in
	}
}
