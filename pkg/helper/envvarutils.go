...
var redisSecretsEnvPathMap = map[string]struct {
	...
	"CONFIG_REDIS_CA_FILE":      {"/tls/backend-redis/backend-redis-ca.crt", "SSL_CA"},
	"CONFIG_REDIS_CERT":         {"/tls/backend-redis/backend-redis-client.crt", "SSL_CERT"},
	"CONFIG_REDIS_PRIVATE_KEY":  {"/tls/backend-redis/backend-redis-private.key", "SSL_KEY"},
