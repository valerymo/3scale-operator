...
* [Installing 3scale](#installing-3scale)
  ...
  * [Deployment Configuration Options](#deployment-configuration-options)
    ...
    * [Apicast: Enabling TLS at pod level](apicast-enabling-tls-at-pod-level.md)
...
_For AWS STS - there are two new fields AWS_ROLE_ARN and AWS_WEB_IDENTITY_TOKEN_FILE are present instead of
AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY._ Please refer to [AWS STS Support](#aws-sts-support) section for details.
